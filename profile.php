            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" src="https://picsum.photos/150" alt="Profile Image">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="inputUsername" type="text" placeholder="Please enter Username" value="singh" disabled>
                            </div>
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputFirstName" type="text" name="first_name" placeholder="Please enter First name" value="Satnam">
                                </div>
                                <!-- Form Group (last name)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputLastName">Last name</label>
                                    <input class="form-control" id="inputLastName" type="text" name="last_name" placeholder="Please enter Last name" value="Singh">
                                </div>
                            </div>
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="inputEmailAddress" type="email" name="email" placeholder="Please enter Email address" value="singh@singh.com">
                            </div>
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
